...
Revision ID: 0c5ef2865c48
Revises: 
Create Date: 2024-01-19 19:00:19.589163
...
def upgrade():
    ...
    sa.Column('contrasena', sa.String(length=250), nullable=False),
    ...
    sa.Column('estado', sa.Boolean(), server_default='f', nullable=False),
    ...
    sa.ForeignKeyConstraint(['id_unidad'], ['unidad.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('id_unidad', 'id_persona', 'id_tarea', name='uq_id_unidad_id_persona_id_tarea')
    )
    ...
    sa.Column('depto_casa', sa.String(length=10), nullable=True),
    sa.Column('id_unidad', sa.Integer(), nullable=False),
