...
const MaquinaEscribirAdmin = () => {
  const [textoVisible, setTextoVisible] = useState('');
  const textoCompleto = [
    "¡Bienvenido a su página de Administrador! Desde acá podrá ver sus cuentas y tareas pendientes, ingresar al panel de Administración y visualizar su perfil de usuario.",
    ...
    "Si desea agregar o eliminar gastos, tareas o inquilinos, o editar la dirección de su unidad habitacional, ingrese al panel de Administración."
  ];
...
export default MaquinaEscribirAdmin;